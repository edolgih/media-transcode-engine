...
public sealed class UnifiedTranscodeRequest
{
    private UnifiedTranscodeRequest(
        string inputPath,
    ...
    public static UnifiedTranscodeRequest Create(
        string InputPath,
        ...
        bool KeepSource = false)
    {
        ...
        var normalizedTargetContainer = RequireAllowedValue(
            ...
            RequestContracts.Unified.Containers);
        var normalizedComputeMode = RequireAllowedValue(
            ...
            RequestContracts.Unified.ComputeModes);
        var normalizedVideoPreset = RequireAllowedValue(
            ...
            RequestContracts.Unified.VideoPresets);
        var normalizedDownscaleAlgo = RequireAllowedValue(
            ...
            RequestContracts.Unified.DownscaleAlgorithms);
        ...
        if (Downscale.HasValue && !RequestContracts.Unified.DownscaleTargets.Contains(Downscale.Value))
        {
        ...
        return new UnifiedTranscodeRequest(
